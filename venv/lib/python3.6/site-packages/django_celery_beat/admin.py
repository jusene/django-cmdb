...
class PeriodicTaskAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', '__str__', 'enabled', 'interval', 'start_time', 'one_off', 'description')
    ...
    toggle_tasks.short_description = _('切换状态')
    ...
    run_tasks.short_description = _('运行任务')
